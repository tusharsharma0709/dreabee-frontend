  ...
  return (
    <div className="row">
      <div className="col-lg-9 pt-4">
        ...
        {/* <div className='create_plan_footer_outer'>
                    <div className='create_plan_footer'>
                        <label>2 Selected</label>
                        ...
                        <div className='d-flex'>
                            ...
                            <button className='btn cross_btn'>
      ...
      <div className="col-lg-3 pt-3 m-0 add_plan_setion">
        ...
        <div className="add_plans_inner">
          <button
            className=" btnz py-2 px-3 plan_add_btn"
        ...
        <div className="View_plan_section">
          <button className="View_plan_btn  btnzOpt">View Plan</button>
        </div>
      </div>
